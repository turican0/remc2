#include "GLGameRender.h"

GLGameRender::GLGameRender(uint16_t screenWidth, uint16_t screenHeight, uint16_t viewPortPosX, uint16_t viewPortPosY, uint16_t viewPortWidth, uint16_t viewPortHeight, uint8_t pX_BYTE_F6EE0_tablesx[])
{

}

GLGameRender::~GLGameRender()
{
