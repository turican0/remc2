...
GameRender::GameRender(uint8_t* pScreenBuffer, uint16_t screenWidth, uint16_t screenHeight, uint16_t viewPortPosX, uint16_t viewPortPosY, uint16_t viewPortWidth, uint16_t viewPortHeight, uint8_t pHeightMap[], std::array<uint8_t*, 256> &textureAdresses, uint8_t pX_BYTE_F6EE0_tablesx[])
{

	SetRenderViewPortSize_BCD45(ViewPort(viewPortPosX, viewPortPosY, viewPortWidth, viewPortHeight), screenWidth, screenHeight);
	SetHeightMap(pHeightMap);
	SetTextures(textureAdresses, m_ptrActTexture);

	m_ptrX_BYTE_F6EE0_tablesx = pX_BYTE_F6EE0_tablesx;
}

void GameRender::DrawWorld(int posX, int posY, int16_t rot, int16_t z, int16_t xshift, int16_t yshift, int16_t dd, type_particle_str** str_DWORD_F66F0x[], uint8_t x_BYTE_E88E0x[], int32_t x_DWORD_F5730[], uint8_t unk_F0A20x[], int16_t x_WORD_180660_VGA_type_resolution, int16_t x_WORD_D4B7C, char isCaveLevel)
{
	...
	v9 = m_ptrHeightmap[v8];
	LOBYTE(v8) += 2;
	v10 = v9;
	v11 = v9;
	v12 = m_ptrHeightmap[v8];
	HIBYTE(v8) += 2;
	v13 = v10 - v12;
	v14 = v12 + v11;
	v15 = m_ptrHeightmap[v8];
	LOBYTE(v8) -= 2;
	v16 = v13 - v15;
	v17 = v14 - v15;
	v18 = m_ptrHeightmap[v8];
	v19 = 2 * (v18 + v16);
	v20 = 2 * (v17 - v18);
	if (v19 <= 100)
	{
	...
	v55 = x_DWORD_D4794 + posX;
	v56 = x_DWORD_D4798 + posY;
	...
	if (D41A0_0.m_GameSettings.str_0x2192.xxxx_0x2193 && m_uiScreenSize && m_uiScreenWidth == 640)
	{
		...
		DrawTerrainAndParticles_3C080(v55 - v26, v56 - v25, v21, z, xshift, yshift, dd, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_WORD_D4B7C, isCaveLevel, m_viewPort, m_uiScreenWidth);
	...
	else if (m_uiScreenSize != 1 || D41A0_0.m_GameSettings.str_0x2192.xxxx_0x2193)
	{
			...
			if (!D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].byte_0x3DF_2BE4_12221)
			{
				if (x_D41A0_BYTEARRAY_4_struct.m_wHighSpeedSystem)
				{
					if (x_DWORD_E9C3C)
					{
						...
						{
							v34 = m_ptrEvents[D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].word_0x00a_2BE4_11240]->word_0x82_130;
		...
		if (D41A0_0.str_0x21AE.xxxx_0x21B1 && D41A0_0.m_GameSettings.m_Display.xxxx_0x2191 && x_DWORD_E9C3C)
		{
			...
			DrawTerrainAndParticles_3C080(v55, v56, v21, z, xshift, yshift, dd, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_WORD_D4B7C, isCaveLevel, m_viewPort, m_uiScreenWidth);
	...
	else
	{
		...
		DrawTerrainAndParticles_3C080(v31 + v55, v30 + v56, v21, z, xshift, yshift, dd, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_WORD_D4B7C, isCaveLevel, m_viewPort, m_uiScreenWidth);
		v32 = m_ptrViewPortRenderBufferStart;
		SetRenderViewPortSize_BCD45(x_DWORD_E9C3C, 0, 0, 0);
		x_DWORD_D4324 = 0 - (m_uiScreenWidth / 40);
		DrawTerrainAndParticles_3C080(v55 - v31, v56 - v30, v21, z, xshift, yshift, dd, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_WORD_D4B7C, isCaveLevel, m_viewPort, m_uiScreenWidth);
...
void GameRender::DrawSky_40950(int16_t roll, uint8_t* ptrViewPortRenderBufferStart, uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t screenWidth)
{
	...
	v1 = roll & 0x7FF;
	v2 = (x_DWORD)x_DWORD_DB750[512 + v1] << 8;
	v26 = (x_DWORD_DB750[v1] << 8) / viewPortWidth;
	v3 = 0;
...
void GameRender::DrawTerrainAndParticles_3C080(__int16 a3, __int16 a4, __int16 a5, signed int a6, int a7, int16_t roll, int a9, type_particle_str** str_DWORD_F66F0x[], uint8_t x_BYTE_E88E0x[], int32_t x_DWORD_F5730[], uint8_t unk_F0A20x[], int16_t x_WORD_D4B7C, char isCaveLevel, ViewPort viewPort, uint16_t screenWidth)
{
	int v9; // eax
	int v10; // edx
	int v11; // ecx
	...
	v22 = *v277;
	m_str_F2C20ar.dword0x22 = a7 * (unsigned __int16)viewPort.Width >> 8;
	LOBYTE(v279) = v22 + HIBYTE(a3);
	HIBYTE(v279) = v277[1] + HIBYTE(a4);
	v23 = roll & 0x7FF;
	m_str_F2C20ar.dword0x11 = (int)x_DWORD_DB750[0x200 + v23];
	m_str_F2C20ar.dword0x16 = 23658496;
	m_str_F2C20ar.dword0x0d = x_DWORD_DB750[v23];
	...
	if (isCaveLevel)//21d3e3 cleaned screen
	{
		...
		for (i = 21; ; i--)
		{
					...
					for (jx = v57x; ; jx = (v80x + 1))
					{
						...
						if ((v66 & v65 & 0x80u) == 0)
						{
							...
							if (!(v67 & 2))
							{
								...
								if (!(v69 & 0xF00))
								{
									DrawInverseSquare(v248x, v68x, m_textureAdresses[1], viewPort.Width, viewPort.Height, screenWidth);
								}
							}
						}
						...
						if (v79 >= 0)
						{
							...
							if (m_Str_E9C38_smalltit[v80x].word36)
								DrawParticles_3E360(v80x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, viewPort, screenWidth);
						}
						v58 = v293 - 1;
					}
					if (v293)
						...
						do
						{
							...
							if ((v92 & v89 & 0x80u) == 0)
							{
								...
								if (!(v93 & 2))
								{
									...
									DrawInverseSquare(v248x, v94x, m_textureAdresses[1], viewPort.Width, viewPort.Height, screenWidth);
								}
							}
							...
							if (v106 >= 0)
							{
								...
								if (m_Str_E9C38_smalltit[v107x].word36)
									DrawParticles_3E360(v107x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, viewPort, screenWidth);
							}
							v83x = v107x - 1;
						} while (v83x >= v82x);
					}
			...
			for (k = 40; k; k--)
			{
				...
				v36 = v279;
				m_Str_E9C38_smalltit[v278x].dword4 = 32 * x_BYTE_11B4E0_heightmap[v279] - a6;
				m_Str_E9C38_smalltit[v278x].dword8 = ((unsigned __int8)x_BYTE_14B4E0_second_heightmap[v36] << 15 >> 10) - a6;
				v37 = 0;
				if (!x_BYTE_10B4E0_terraintype[v36])
				{
					...
					m_Str_E9C38_smalltit[v278x].dword4 -= v37 >> 13;
					if (v33 >= 14464)
						v37 = 0;
				}
				v39 = (v33 << 8) + 8 * v37;
			...
			LABEL_40:
				...
				v41x = v278x;
				m_Str_E9C38_smalltit[v278x].dword20 = m_str_F2C20ar.dword0x22 + m_str_F2C20ar.dword0x18 * m_Str_E9C38_smalltit[v278x].dword4 / v34;
				...
				m_Str_E9C38_smalltit[v278x].byte43 = x_BYTE_D41D8[m_Str_E9C38_smalltit[v278x].byte41];
				m_Str_E9C38_smalltit[v278x].byte42 = v248x[32] + (((signed int)(unsigned __int8)x_BYTE_13B4E0_angle[v42] >> 2) & 0x1C);
	...
	if (D41A0_0.m_GameSettings.m_Graphics.m_wReflections)
	{
		for (l = 21; ; l--)
		{
					...
					for (m = 20; m; --m)
					{
						...
						for (n = 39; n; --n)
						{
							...
							if (m_Str_E9C38_smalltit[v143x].word36)
								sub_3FD60(v143x, str_DWORD_F66F0x, x_DWORD_F5730, viewPort);
							v134x = v143x + 1;
						}
						if (n)
						{
							...
							do
							{
								...
								if (m_Str_E9C38_smalltit[v155x].word36)
									sub_3FD60(v155x, str_DWORD_F66F0x, x_DWORD_F5730, viewPort);
								v147x = v155x - 1;
							} while (v147x >= v25z);
						}
						v133x -= 40;
				...
				do
				{
					...
					for (ii = 39; ii; --ii)
					{
						...
						if (m_Str_E9C38_smalltit[v172x].word36)
							DrawParticles_3E360(v172x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, viewPort, screenWidth);
						v161 = v172x + 1;
					}
					if (ii)
					{
						...
						do
						{
							...
							if (m_Str_E9C38_smalltit[v190x].word36)
								DrawParticles_3E360(v190x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, viewPort, screenWidth);
							v178x = v190x - 1;
						} while (v178x >= v177x);
					}
					v160 -= 40;
			...
			for (jj = 40; jj; --jj)
			{
				...
				m_Str_E9C38_smalltit[v278x].dword8 = -(v248x[26] * ((v113 >> 4) + 0x8000) >> 10) - a6;
				if (!(x_BYTE_13B4E0_angle[v111] & 8) || (m_Str_E9C38_smalltit[v278x].dword4 -= v113 >> 10, v248x[31] >= 14464))
				{
					v113 = 0;
				}
			...
			LABEL_134:
				v117x = v278x;
				m_Str_E9C38_smalltit[v278x].dword20 = m_str_F2C20ar.dword0x22 + m_str_F2C20ar.dword0x18 * m_Str_E9C38_smalltit[v278x].dword4 / v109;
				...
				v120x = v278x;
				m_Str_E9C38_smalltit[v278x].byte43 = x_BYTE_D41D8[m_Str_E9C38_smalltit[v278x].byte41];
				m_Str_E9C38_smalltit[v120x].byte42 = v248x[32] + (((signed int)(unsigned __int8)x_BYTE_13B4E0_angle[v118] >> 2) & 0x1C);
...
LABEL_259:
	if (v283)
	{
		...
		m_Str_E9C38_smalltit[v278x].dword4 = 32 * x_BYTE_11B4E0_heightmap[v200] - a6;
		...
		if (!(x_BYTE_13B4E0_angle[v200] & 8) || (m_Str_E9C38_smalltit[v278x].dword4 -= v202 >> 10, v197 >= 14464))
			v202 = 0;
		v203 = (v197 << 8) + 8 * v202;
		if (v199 > m_str_F2C20ar.dword0x13)
		{
			if (v199 >= m_str_F2C20ar.dword0x16)
			{
				m_Str_E9C38_smalltit[v278x].dword32 = 0;
			LABEL_254:
				m_Str_E9C38_smalltit[v278x].dword20 = m_str_F2C20ar.dword0x22 + m_str_F2C20ar.dword0x18 * m_Str_E9C38_smalltit[v278x].dword4 / v198;
				LOBYTE(v204) = v277[2] + v279;
				HIBYTE(v204) = v277[3] + HIBYTE(v279);
				v205x = v278x;
				m_Str_E9C38_smalltit[v278x].byte41 = x_BYTE_10B4E0_terraintype[v204];
				m_Str_E9C38_smalltit[v205x].byte43 = x_BYTE_D41D8[m_Str_E9C38_smalltit[v205x].byte41];
				m_Str_E9C38_smalltit[v205x].byte42 = v248x[32] + (((signed int)(unsigned __int8)x_BYTE_13B4E0_angle[v204] >> 2) & 0x1C);
	...
	do
	{
		...
		for (kk = 39; kk; kk--)
		{
			...
			if (m_Str_E9C38_smalltit[v227x].word36)
				DrawParticles_3E360(v227x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, viewPort, screenWidth);//21f01b
			v218x = v227x + 1;
		}
		if (kk)
		{
			...
			do
			{
				...
				if (m_Str_E9C38_smalltit[v243x].word36)//address 21f1b5 aex 360000 ebx 3f78a0 ecx 0 edx 414eb0
					DrawParticles_3E360(v243x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, viewPort, screenWidth);
				v232x = v243x - 1;
			} while (v232x >= v231x);
		}
		v217x -= 40;
...
uint16_t GameRender::sub_3FD60(int a2x, type_particle_str** str_DWORD_F66F0x[], int32_t x_DWORD_F5730[], ViewPort viewPort)
{
	uint16_t result; // ax
			...
			if (!(v3x->struct_byte_0xc_12_15.byte[0] & 0x21))
			{
				...
				if (v7 > 64 && v8 < m_str_F2C20ar.dword0x15)
				{
					...
					case 17:
						...
						m_str_F2C20ar.dword0x08_width = a1x->word_2;
						m_str_F2C20ar.dword0x06_height = a1x->word_4;
					...
					LABEL_70:
						...
						m_str_F2C20ar.dword0x02_data = a1x->data_6;
						...
						DrawSprite_41BD3(2u, viewPort, 640);
						break;
					default:
						goto LABEL_70;
					}
...
void GameRender::sub_88740(type_event_0x6E8E* a1x, int a2, int a3)
{
	int v3; // esi
...
void GameRender::SetBillboards_3B560(int16_t roll, uint8_t unk_F0A20x[], uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t screenWidth)
{
	...
	case 4:
		...
		m_str_F2C20ar.dword0x27 = x_DWORD_DB750[v1 - 0x400];//copy to other
		//str_F2C20ar.dword0x1b = *(int32_t*)&x_DWORD_DAF50ar[v1*4];
		m_str_F2C20ar.dword0x1b = x_DWORD_DB750[v1 - 0x200];//copy to other
	...
	case 6:
		...
		m_str_F2C20ar.dword0x27 = x_DWORD_DB750[v1 - 0x600];//copy to other
		//str_F2C20ar.dword0x1b = *(int32_t*)&x_DWORD_DA750ar[v1*4];
		m_str_F2C20ar.dword0x1b = x_DWORD_DB750[v1 - 0x400];//copy to other
...
void GameRender::DrawSorcererNameAndHealthBar_2CB30(type_event_0x6E8E* a1x, __int16 a2, int a3, __int16 a4, int16_t viewPortX, int16_t viewPortY, uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t pitch)
{
	//char *v4; // edi
	char* v5; // esi
	//char v6; // al
...
bool GameRender::MainInitTmaps_71520(uint16_t a1)
{
	int v1; // esi
	int v2; // ebx
	signed int i; // ebx
...
void GameRender::DrawSquare(int* vertexs, int index, uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t screenWidth)
{
	...
	vertexs[14] = xunk_D4350[m_Str_E9C38_smalltit[index].byte42][2];
	vertexs[15] = xunk_D4350[m_Str_E9C38_smalltit[index].byte42][3];
	vertexs[8] = xunk_D4350[m_Str_E9C38_smalltit[index].byte42][4];
	vertexs[9] = xunk_D4350[m_Str_E9C38_smalltit[index].byte42][5];
	vertexs[2] = xunk_D4350[m_Str_E9C38_smalltit[index].byte42][6];
	vertexs[3] = xunk_D4350[m_Str_E9C38_smalltit[index].byte42][7];
	uint8_t* pTexture = m_textureAdresses.at(m_Str_E9C38_smalltit[index].byte41);
...
{
	DrawInverseSquare(vertexs, index, m_textureAdresses.at(m_Str_E9C38_smalltit[index].byte41), viewPortWidth, viewPortHeight, screenWidth);
}
...
void GameRender::DrawParticles_3E360(int a2x, type_particle_str** str_DWORD_F66F0x[], uint8_t x_BYTE_E88E0x[], int32_t x_DWORD_F5730[], ViewPort viewPort, uint16_t screenWidth)
{
	...
	do
	{
		...
		if (!(v3x->struct_byte_0xc_12_15.byte[0] & 0x21))
		{
					...
					if (v99 > 64 && v6 < m_str_F2C20ar.dword0x15)
					{
						...
						if (!v7x->byte_10)
						{
							...
							case 17:
								...
								m_str_F2C20ar.dword0x08_width = a1y->word_2;
								m_str_F2C20ar.dword0x06_height = a1y->word_4;
							...
							LABEL_73:
								...
								m_str_F2C20ar.dword0x02_data = a1y->data_6;
								...
								if (m_str_F2C20ar.dword0x09_realWidth > 0 && v46 > 0)
								{
									...
									DrawSprite_41BD3(0, viewPort, screenWidth);
								}
								break;
							default:
								goto LABEL_73;
			...
			if (m_str_F2C20ar.dword0x14x->struct_byte_0xc_12_15.byte[3] & 0x20)
			{
				...
				switch ((((m_ptrEvents[m_str_F2C20ar.dword0x14x->word_0x32_50]->word_0x1C_28
			...
			if (v100 > 64 && v51 < m_str_F2C20ar.dword0x15)
			{
				...
				LABEL_164:
					...
					if (v91 & 0x380)
					{
						...
						if (v93 & 2)
						{
							v94 = (unsigned __int8)x_BYTE_E88E0x[0x2 + 3
								* m_ptrEvents[v90x->word_0x28_40]->dword_0xA4_164x->word_0x38_56];
					...
					m_str_F2C20ar.dword0x09_realWidth++;
					m_str_F2C20ar.dword0x0c_realHeight++;
					DrawSprite_41BD3(1u, viewPort, screenWidth);
					break;
				default:
					goto LABEL_164;
				}
...
void GameRender::DrawSprite_41BD3(uint32 a1, ViewPort viewPort, uint16_t pitch)
{
	//int v1; // eax
	int8_t* v2x; // ebx
	x_DWORD* v3; // esi
		...
		else
		{
			...
			LABEL_126:
				...
				if (a1 == 1)
				{
					...
					{
						DrawSorcererNameAndHealthBar_2CB30(m_str_F2C20ar.dword0x14x, m_str_F2C20ar.dword0x04_screenY, (signed __int16)m_str_F2C20ar.dword0x03_screenX, m_str_F2C20ar.dword0x09_realWidth, viewPort.PosX, viewPort.PosY, viewPort.Width, viewPort.Height, pitch);
					}
					if (x_D41A0_BYTEARRAY_4_struct.byteindex_10)
						sub_88740(
							...
							(signed __int16)(m_str_F2C20ar.dword0x03_screenX + (m_str_F2C20ar.dword0x0c_realHeight >> 1)), m_x_WORD_180660_VGA_type_resolution);
...
void GameRender::DrawTriangle_B6253(x_DWORD* a1, x_DWORD* a2, x_DWORD* a3, uint8_t* pTexture, uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t screenWidth)
{
	x_DWORD* v3; // esi
	x_DWORD* v4; // edi
	x_DWORD* v5; // ecx
...
void GameRender::SetHeightMap(uint8_t* pHeightMap)
{
	m_ptrHeightmap = pHeightMap;
}

void GameRender::SetTextures(std::array<uint8_t*, 256> &textureAdresses, uint8_t pActTexture[])
{
	m_textureAdresses = textureAdresses;
	m_ptrActTexture = pActTexture;
}

void GameRender::SetEvents(type_event_0x6E8E* ptrEvents)
{
	m_ptrEvents = ptrEvents;
}
...
void GameRender::SetStr_F2C20ar(type_F2C20ar str_F2C20ar)
{
	m_str_F2C20ar = str_F2C20ar;
}
...
void GameRender::SetRenderViewPortSize_BCD45(ViewPort viewPort, uint16_t screenWidth, uint16_t screenHeight)
{
	...
	SetRenderViewPortSize_BCD45(m_ptrScreenBuffer + ptrScreenRenderBufferStart, m_viewPort.Width, m_viewPort.Height, m_uiScreenWidth);
}
...
void GameRender::SetRenderViewPortSize_BCD45(uint8_t viewPortSizeSetting, uint16_t screenWidth, uint16_t screenHeight)
{
	...
	viewPort.PosX = viewPortWidthMultipler * viewPortSizeSetting;
	viewPort.PosY = viewPortHeightMultipler * viewPortSizeSetting;
	viewPort.Width = viewPortWidthMultipler * (viewPortSizeSetting * v1);
	viewPort.Height = viewPortHeightMultipler * (viewPortSizeSetting * v1);
