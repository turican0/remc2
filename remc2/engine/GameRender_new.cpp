...
void GameRender_new::DrawWorld(int posX, int posY, int16_t yaw, int16_t posZ, int16_t ScreenWidth, int16_t roll, int16_t fov, uint8_t mapHeightmap_11B4E0xx[], type_particle_str** str_DWORD_F66F0x[], uint8_t x_BYTE_E88E0x[], int32_t x_DWORD_F5730[], uint8_t unk_F0A20x[], type_event_0x6E8E* x_DWORD_EA3E4[], type_str_unk_1804B0ar str_unk_1804B0ar, int16_t x_WORD_180660_VGA_type_resolutionxx, int16_t x_WORD_D4B7C, char isCaveLevel)
{
	...
	if (D41A0_0.m_GameSettings.str_0x2192.xxxx_0x2193 && m_uiScreenSize && screenWidth_18062C == 640)
	{
		//uint16_t origScreenWidth = screenWidth_18062C;
		//uint16_t origScreenHeight = screenHeight_180624;
		...
		DrawTerrainAndParticles_3C080(vPosX - v26, vPosY - v25, vYaw, posZ, ScreenWidth, roll, fov, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_DWORD_EA3E4, str_unk_1804B0ar, x_WORD_D4B7C, isCaveLevel, m_viewPort, screenWidth_18062C);
		SetRenderViewPortSize_BCD45(pdwScreenBuffer_351628 + (screenWidth_18062C / 2), 0, 0, 0);
		x_DWORD_D4324 = 5;
		DrawTerrainAndParticles_3C080(vPosX + v26, vPosY + v25, vYaw, posZ, ScreenWidth, roll, fov, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_DWORD_EA3E4, str_unk_1804B0ar, x_WORD_D4B7C, isCaveLevel, m_viewPort, screenWidth_18062C);
		x_DWORD_D4324 = 0;
		SetRenderViewPortSize_BCD45(pdwScreenBuffer_351628, screenWidth_18062C, screenHeight_180624, screenWidth_18062C);
	}
	else if (m_uiScreenSize != 1 || D41A0_0.m_GameSettings.str_0x2192.xxxx_0x2193)
	{
		...
		if (D41A0_0.str_0x21AE.xxxx_0x21B1 && D41A0_0.m_GameSettings.m_Display.xxxx_0x2191 && x_DWORD_E9C3C)
		{
			...
			DrawTerrainAndParticles_3C080(vPosX, vPosY, vYaw, posZ, ScreenWidth, roll, fov, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_DWORD_EA3E4, str_unk_1804B0ar, x_WORD_D4B7C, isCaveLevel, m_viewPort, screenWidth_18062C);
			//Apply Blur
			SetRenderViewPortSize_BCD45(v35, 0, 0, 0);
			v51 = (signed int)(unsigned __int16)m_viewPort.Width_DE564 >> 2;
			v49 = screenWidth_18062C - (unsigned __int16)m_viewPort.Width_DE564;
	...
	else
	{
		...
		x_DWORD_D4790 = 20;
		x_DWORD_D4324 = screenWidth_18062C / 40;
		v30 = 4 * v28 >> 16;
		v31 = 20 * (signed int)v29 >> 16;
		DrawTerrainAndParticles_3C080(v31 + vPosX, v30 + vPosY, vYaw, posZ, ScreenWidth, roll, fov, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_DWORD_EA3E4, str_unk_1804B0ar, x_WORD_D4B7C, isCaveLevel, m_viewPort, screenWidth_18062C);
		v32 = ViewPortRenderBufferStart_DE558;
		SetRenderViewPortSize_BCD45(x_DWORD_E9C3C, 0, 0, 0);
		x_DWORD_D4324 = 0 - (screenWidth_18062C / 40);
		DrawTerrainAndParticles_3C080(vPosX - v31, vPosY - v30, vYaw, posZ, ScreenWidth, roll, fov, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730, unk_F0A20x, x_DWORD_EA3E4, str_unk_1804B0ar, x_WORD_D4B7C, isCaveLevel, m_viewPort, screenWidth_18062C);
...
void GameRender_new::DrawSprite_41BD3(uint32 a1, uint8_t x_BYTE_E88E0x[], type_event_0x6E8E* x_DWORD_EA3E4[], type_str_unk_1804B0ar str_unk_1804B0ar, ViewPort viewPort, uint16_t pitch)
{
			...
			LABEL_126:
				...
				if ((unsigned int)m_str_F2C20ar.dword0x1e <= 7)
				{
					...
					case 2:
						...
						v170 = m_str_F2C20ar.dword0x21;
					LABEL_329:
						v123 = m_str_F2C20ar.width0x25 + ViewPortRenderBufferStart_DE558 - 1 - v170;
					...
					case 3:
						...
						v123 = m_str_F2C20ar.height0x26 + pitch * v171 - 1 + ViewPortRenderBufferStart_DE558;
					...
					case 4:
						...
						v170 = m_str_F2C20ar.dword0x21;
					LABEL_348:
						v123 = m_str_F2C20ar.height0x26 + ViewPortRenderBufferStart_DE558 + pitch * (m_str_F2C20ar.width0x25 - v170 - 1) - 1;
					...
					case 5:
						...
						v123 = (m_str_F2C20ar.height0x26 - 1) * pitch + m_str_F2C20ar.width0x25 + ViewPortRenderBufferStart_DE558 - 1 - v171;
					...
					case 6:
						...
						v170 = m_str_F2C20ar.dword0x21;
					LABEL_367:
						v123 = ViewPortRenderBufferStart_DE558 + pitch * (m_str_F2C20ar.height0x26 - 1) + v170;
					...
					case 7:
						...
						v123 = pitch * (m_str_F2C20ar.width0x25 - 1 - v171) + ViewPortRenderBufferStart_DE558;
	...
	if ((unsigned __int16)viewPort.Width_DE564 > m_str_F2C20ar.dword0x04_screenY)
	{
		...
		if ((unsigned __int16)viewPort.Height_DE568 > m_str_F2C20ar.dword0x03_screenX)
		{
			...
			//               screen-Y                                            screen-X
			v122x = &ViewPortRenderBufferStart_DE558[m_str_F2C20ar.dword0x03_screenX * pitch + m_str_F2C20ar.dword0x04_screenY];
			//height
...
void GameRender_new::DrawTriangleInProjectionSpace_B6253(const ProjectionPolygon* vertex1, const ProjectionPolygon* vertex2, const ProjectionPolygon* vertex3, uint8_t* pTexture, uint8_t unk_DE56Cx[], uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t pitch, uint8_t startLine, uint8_t drawEveryNthLine)
{
...
void GameRender_new::SetRenderViewPortSize_BCD45(ViewPort viewPort, uint16_t screenWidth, uint16_t screenHeight)
{
	...
	int32_t ptrScreenRenderBufferStart = m_viewPort.PosX_EA3D0 + screenWidth_18062C * m_viewPort.PosY_EA3CC;
	SetRenderViewPortSize_BCD45(ptrScreenRenderBufferStart + pdwScreenBuffer_351628, m_viewPort.Width_DE564, m_viewPort.Height_DE568, screenWidth_18062C);
}

void GameRender_new::SetRenderViewPortSize_BCD45(uint8_t* ptrScreenBufferStart, uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t screenWidth)
{
	if (screenWidth)
	{
		screenWidth_18062C = screenWidth;
	...
	if (ptrScreenBufferStart)
	{
		...
		m_ptrViewPortRenderBufferAltStart_DE554 = ptrScreenBufferStart - screenWidth_18062C;
	}
