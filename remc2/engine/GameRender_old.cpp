...
//void GameRender_old::DrawWorld(int posX, int posY, int16_t yaw, int16_t posZ, int16_t iScreenWidth_DE560, int16_t roll, int16_t fov, uint8_t mapHeightmap_11B4E0[], type_particle_str** str_DWORD_F66F0x[], uint8_t x_BYTE_E88E0x[], int32_t x_DWORD_F5730[], uint8_t unk_F0A20x[], type_event_0x6E8E* x_DWORD_EA3E4[], type_str_unk_1804B0ar str_unk_1804B0ar, int16_t x_WORD_180660_VGA_type_resolution, int16_t x_WORD_D4B7C, char isCaveLevel_D41B6)
{
	...
	else if (D41A0_0.m_GameSettings.m_Display.m_uiScreenSize != 1 || D41A0_0.m_GameSettings.str_0x2192.xxxx_0x2193)
	{
		...
		if (D41A0_0.str_0x21AE.xxxx_0x21B1 && D41A0_0.m_GameSettings.m_Display.xxxx_0x2191 && x_DWORD_E9C3C)
		{
			...
			DrawTerrainAndParticles_3C080(vPosX, vPosY, vYaw, posZ, ScreenWidth, roll, fov);
			//Apply Blur
			SetRenderViewPortSize_BCD45(v35, 0, 0, 0);
			v51 = (signed int)(unsigned __int16)viewPort.Width_DE564 >> 2;
			v49 = ScreenWidth - (unsigned __int16)viewPort.Width_DE564;
	...
	else
	{
		...
		x_DWORD_D4790 = 20;
		x_DWORD_D4324 = ScreenWidth / 40;
		v30 = 4 * v28 >> 16;
		v31 = 20 * (signed int)v29 >> 16;
		DrawTerrainAndParticles_3C080(v31 + vPosX, v30 + vPosY, vYaw, posZ, ScreenWidth, roll, fov);
		v32 = ViewPortRenderBufferStart_DE558;
		SetRenderViewPortSize_BCD45(x_DWORD_E9C3C, 0, 0, 0);
		x_DWORD_D4324 = 0 - (ScreenWidth / 40);
		DrawTerrainAndParticles_3C080(vPosX - v31, vPosY - v30, vYaw, posZ, ScreenWidth, roll, fov);
		SetRenderViewPortSize_BCD45(v32, 0, 0, 0);
		x_DWORD_D4324 = 0;
	}
}

void GameRender_old::WriteWorldToBMP()
{
	char path[MAX_PATH];
...
void GameRender_old::StartWorkerThreads(uint8_t numOfThreads, bool assignToSpecificCores)
{
...
void GameRender_old::StartWorkerThread()
{
...
void GameRender_old::StartWorkerThread(int core)
{
...
void GameRender_old::StopWorkerThreads()
{
	if (m_renderThreads.size() > 0)
	{
...
void GameRender_old::DrawSquareInProjectionSpace(std::vector<int>& vertexs, int index, uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t iScreenWidth_DE560)
{
...
void GameRender_old::DrawParticles_3E360(int a2x, type_particle_str** str_DWORD_F66F0x[], uint8_t x_BYTE_E88E0x[], int32_t x_DWORD_F5730[], type_event_0x6E8E* x_DWORD_EA3E4[], type_str_unk_1804B0ar str_unk_1804B0ar, ViewPort viewPort, uint16_t iScreenWidth_DE560)
{
...
void GameRender_old::DrawTriangleInProjectionSpace_B6253(const ProjectionPolygon* vertex1, const ProjectionPolygon* vertex2, const ProjectionPolygon* vertex3/*, uint8_t* x_DWORD_DE55C_ActTexture, uint8_t unk_DE56Cx[], uint16_t viewPortWidth, uint16_t viewPortHeight, uint16_t iScreenWidth_DE560, uint8_t startLine, uint8_t drawEveryNthLine*/)
{
	int startLine = 0;//stub!!!!!!!!!!!!!!!!!!
	int drawEveryNthLine = 0;//stub!!!!!!!!!!!!!!!!!!
...
x_DWORD* GameRender_old::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int s0, int s1, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
x_DWORD* GameRender_old::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int* v4, int s0, int s1, int s4, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
x_DWORD* GameRender_old::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int* v2, int* v3, int s0, int s1, int s2, int s3, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
x_DWORD* GameRender_old::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int* v2, int* v3, int* v4, int s0, int s1, int s2, int s3, int s4, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
void GameRender_old::SetTextures(std::array<uint8_t*, 256>& textureAdresses)
{
...
void GameRender_old::WaitForRenderFinish()
{
	int taskCount = 0;
