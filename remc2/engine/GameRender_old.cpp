...
/* ---- */void GameRender_old::DrawTriangleInProjectionSpace_B6253(x_DWORD* a1, x_DWORD* a2, x_DWORD* a3)//sub_B6253 - 297253
{
	x_DWORD* v3; // esi
	x_DWORD* v4; // edi
	x_DWORD* v5; // ecx
	...
	*/
	...
	if (v6 <= v7)
	{
					...
					case 0xF:
						...
						if (!v1292)
						{
							if (v1300)
							{
								...
								v1123 = viewPort.Height_DE568 - v1190;
								if (v1296)
								{
		...
		LABEL_234:
			...
			case 0xF:
				...
				{
					v1123 = viewPort.Height_DE568 - v1192;
	...
	LABEL_277:
		...
		case 0xF:
			...
			{
				v1123 = viewPort.Height_DE568 - v1193;
	...
	if (((*v4 - *v3) << 16) / v68 > v1104)
	{
		...
		case 0xF:
			...
			else if (v1301)
			{
				...
				v1123 = viewPort.Height_DE568 - v1191;
				if (v1297)
				{
