...
void sub_8D290_init_sound(/*char* a1*//*, int a2, int a3*/)//26e290
{
	...
	if (!DirExists(soundGamePath))
	{
		soundActive2_E3798 = 0;
		soundCard_E3799 = 0;
		if (musicInicialized_E37FC && x_BYTE_E37FE)
		{
			sub_99C90();
		}
		else
...
void /*__fastcall*/ sub_8D970_init_music(/*char* a1*//*int a1, int a2, char* a3*/)//26e970
{
	...
	LABEL_69:
		if (musicInicialized_E37FC && LoadMusic(x_BYTE_E3814))
		{
			if (x_BYTE_E3815 == 1)
			{
				sub_9FA80();
...
{
	if (musicInicialized_E37FC && musicStarted_E37FD && x_WORD_E3802)
	{
		if (x_BYTE_E3818)
...
void StartMusic_8E160(__int16 track, unsigned __int8 volume)//26f160
{
	...
	if (musicInicialized_E37FC && musicStarted_E37FD && track <= m_iNumberOfTracks && x_WORD_E3802 != track)
	{
		if (x_BYTE_E3818)
			;// sub_92DC0_AIL_release_timer_handle(x_DWORD_180C80);
		x_BYTE_E3819 = 0;
...
signed int sub_919C0()
{
	...
	x_DWORD_181C04++;
	v1 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v1)
...
int sub_91A80_AIL_set_preference(uint32_t number, int32_t value)//int (__stdcall *mss32_AIL_set_preference)(unsigned int, int) = 0;
{
	...
	x_DWORD_181C04++;
	v5 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v5)
...
uint16_t sub_91C10_AIL_get_real_vect(/*VDI_HDR* a1, int a2, int a3,*/ uint32_t vectnum/*U32       vectnum*/)//AIL_get_real_vect
{
	...
	x_DWORD_181C04++;
	v8 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && (v4 = sub_A16A2(), !v4 && DebugSoundTimer_916F0());
	if (v8)
...
void sub_91D50_AIL_set_real_vect(uint32_t vectnum, uint16_t real_ptr)//AIL_set_real_vect
{
	...
	x_DWORD_181C04++;
	v3 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v3)
...
void sub_91E90_AIL_restore_USE16_ISR(int32_t a1)//AIL_restore_USE16_ISR
{
	...
	x_DWORD_181C04++;
	v2 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v2)
...
HDIGDRIVER sub_93330_AIL_install_DIG_driver_file(/*int a1, */char* filename, IO_PARMS* IO)//AIL_install_DIG_driver_file // 274330
{
	...
	x_DWORD_181C04++;
	v6 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v6)
...
HSAMPLE sub_93510_AIL_allocate_sample_handle(HDIGDRIVER dig/*HDIGDRIVER dig*/)//AIL_allocate_sample_handle //00274510
{
	...
	x_DWORD_181C04++;
	v4 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v4)
...
{
	if (musicInicialized_E37FC && musicStarted_E37FD && x_WORD_E3802 && volume <= 0x7Fu && sub_96170_AIL_sequence_status(m_hSequence) != 2)
...
{
	if (musicInicialized_E37FC && !_stricmp(unk_180BE0, "SBAWE32.MDI") && !_stricmp(&x_BYTE_180C84_drivertype, "w"))
	{
...
int32_t sub_91F70_AIL_call_driver(AIL_DRIVER* drvr, int32_t fn, VDI_CALL* in, VDI_CALL* out)//AIL_call_driver //272f70
{
	...
	x_DWORD_181C04++;
	v7 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v7)
...
int LoadAILFromFile(AIL_INI* INI, char* filename/*, char* a8, IO_PARMS IO*/)//AIL_read_INI // 273190
{
	...
	x_DWORD_181C04++;
	v17 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !sub_A16A2() && DebugSoundTimer_916F0();
	if (v17)
...
{
	if (x_BYTE_E3819 && musicInicialized_E37FC && musicStarted_E37FD && x_WORD_E3802 && sub_96170_AIL_sequence_status(m_hSequence) != 2 && x_BYTE_E3817 != a1)
	{
		if (x_BYTE_E3818)
			;// sub_92DC0_AIL_release_timer_handle(x_DWORD_180C80);
		x_BYTE_E3817 = a1;
