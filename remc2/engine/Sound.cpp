...
void sub_8D290_init_sound(/*char* a1*//*, int a2, int a3*/)//26e290
{
	...
	if (!DirExists(soundGamePath))
	{
		soundActive2_E3798 = 0;
		soundCard_E3799 = 0;
		if (musicInitialized_E37FC && x_BYTE_E37FE)
		{
			sub_99C90();
		}
		else
...
void EndSample_8D8F0()//26e8f0
{
	...
	//i fix
	if (soundActive2_E3798 && soundCard_E3799)//ma to byt 0 a 0 2b4798
	{
...
void /*__fastcall*/ sub_8D970_init_music(/*char* a1*//*int a1, int a2, char* a3*/)//26e970
{
	...
	LABEL_69:
		if (musicInitialized_E37FC && LoadMusic(x_BYTE_E3814))
		{
			if (x_BYTE_E3815 == 1)
			{
				sub_9FA80();
...
{
	if (musicInitialized_E37FC && musicStarted_E37FD && x_WORD_E3802)
	{
		if (x_BYTE_E3818)
...
//----- (0008E160) --------------------------------------------------------
void StartMusic_8E160(__int16 track, unsigned __int8 volume)//26f160
{
	//unsigned __int8 i; // [esp+0h] [ebp-4h]

	if (musicInitialized_E37FC && musicStarted_E37FD && track <= m_iNumberOfTracks && x_WORD_E3802 != track)
	{
		if (x_BYTE_E3818)
			;// sub_92DC0_AIL_release_timer_handle(x_DWORD_180C80);
		x_BYTE_E3819 = 0;
...
signed int sub_919C0()
{
	...
	x_DWORD_181C04++;
	v1 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !GetE3FFE_A16A2() && DebugSoundTimer_916F0();
	if (v1)
		dbgfprintf(x_DWORD_181BF0_AIL_debugfile, "AIL_shutdown()\n");
	result = sub_9ED70();
	if (x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8))
	{
		result = GetE3FFE_A16A2();
		if (!result)
...
int sub_91A80_AIL_set_preference(uint32_t number, int32_t value)//int (__stdcall *mss32_AIL_set_preference)(unsigned int, int) = 0;
{
	...
	x_DWORD_181C04++;
	v5 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !GetE3FFE_A16A2() && DebugSoundTimer_916F0();
	if (v5)
...
uint16_t sub_91C10_AIL_get_real_vect(/*VDI_HDR* a1, int a2, int a3,*/ uint32_t vectnum/*U32       vectnum*/)//AIL_get_real_vect
{
	...
	x_DWORD_181C04++;
	v8 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && (v4 = GetE3FFE_A16A2(), !v4 && DebugSoundTimer_916F0());
	if (v8)
...
void sub_91D50_AIL_set_real_vect(uint32_t vectnum, uint16_t real_ptr)//AIL_set_real_vect
{
	...
	x_DWORD_181C04++;
	v3 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !GetE3FFE_A16A2() && DebugSoundTimer_916F0();
	if (v3)
...
void sub_99C90()//27ac90
{
	if (x_BYTE_E37FE)
	{
		...
		{
			FreeMem_83E80((uint8_t*)str_E3808_music_header);
			index_E380C_CountOfMusic = 0;
		}
		if (array_E3810_music_data)
			FreeMem_83E80(array_E3810_music_data);
		musicInitialized_E37FC = 0;
		musicStarted_E37FD = 0;
		x_BYTE_E37FE = 0;
	}
...
void AilSetSequenceVolume_96030(int32_t volume, int32_t  milliseconds)//AIL_set_sequence_volume
{
...
//----- (00084300) --------------------------------------------------------
int32_t LoadSound_84300(uint8_t a1)//265300
{
	FILE* file; // eax
	//FILE* v2; // ebx
	//FILE* v3; // edi
...
AIL_DRIVER* sub_9E720_AIL_API_install_driver(/*int a1, */uint8_t* driver_image, int32_t n_bytes)//27f720
{
	...
	{
		v14->size_3 = n_bytes;
		if (AllocMem_9D4D0((n_bytes + 15) >> 4, (uint8_t**)&v14->buf_2, &v14->seg_0, &v14->sel_1))
		{
			...
			else
			{
				if (_strnicmp((char*)v14->VHDR_4->ID_8, "AIL3MDI", 7))
				{
					...
					//v5 = v14->sel_1;
					//v6 = v14->seg_0;
					FreeMem_9D560((uint8_t*)v14->buf_2);
					FreeMem_9D490(v14, 44);
					return 0;
				}
				v14->type_5 = 1;
			}
...
int sub_9EA60_AIL_API_uninstall_driver(AIL_DRIVER* a1)
{
	...
	//v1 = a1->sel_1;
	//v2 = a1->seg_0;
	FreeMem_9D560((uint8_t*)a1->buf_2);
...
{
	if (musicInitialized_E37FC && !_stricmp(unk_180BE0, "SBAWE32.MDI") && !_stricmp(&x_BYTE_180C84_drivertype, "w"))
	{
...
char LoadMusicTrack(FILE* filehandle, uint8_t drivernumber)//26fd00
{
	...
	array_E3810_music_data = (uint8_t*)Malloc_83CD0(headerx[drivernumber].dword_12);
	if (!array_E3810_music_data)
		return 0;
	...
	str_E3808_music_header = (type_E3808_music_header*)Malloc_83CD0(sizeof(type_E3808_music_header));
	if (!str_E3808_music_header)
	{
		FreeMem_83E80(array_E3810_music_data);
		return 0;
...
int32_t sub_91F70_AIL_call_driver(AIL_DRIVER* drvr, int32_t fn, VDI_CALL* in, VDI_CALL* out)//AIL_call_driver //272f70
{
	...
	x_DWORD_181C04++;
	v7 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !GetE3FFE_A16A2() && DebugSoundTimer_916F0();
	if (v7)
...
int LoadAILFromFile(AIL_INI* INI, char* filename/*, char* a8, IO_PARMS IO*/)//AIL_read_INI // 273190
{
	...
	x_DWORD_181C04++;
	v17 = x_DWORD_181BF4 && (x_DWORD_181C04 == 1 || x_DWORD_181BF8) && !GetE3FFE_A16A2() && DebugSoundTimer_916F0();
	if (v17)
...
{
	if (x_BYTE_E3819 && musicInitialized_E37FC && musicStarted_E37FD && x_WORD_E3802 && sub_96170_AIL_sequence_status(m_hSequence) != 2 && x_BYTE_E3817 != a1)
	{
		if (x_BYTE_E3818)
			;// sub_92DC0_AIL_release_timer_handle(x_DWORD_180C80);
		x_BYTE_E3817 = a1;
