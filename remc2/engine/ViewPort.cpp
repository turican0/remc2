...
{
	ViewPort viewPort = SetRenderViewPortSize_40C50(viewPortSizeSetting, screenWidth_18062C, screenHeight_180624);
	int32_t ptr = (screenWidth_18062C * viewPort.PosY_EA3CC) + viewPort.PosX_EA3D0;
	str_F2C20ar.dword0x0e_ptrScreenRenderBufferStart = ptr;
	SetRenderViewPortSize_BCD45(pdwScreenBuffer_351628 + ptr, screenWidth_18062C, viewPort.Width_DE564, viewPort.Height_DE568);
}

ViewPort ViewPort::SetRenderViewPortSize_40C50(uint8_t viewPortSizeSetting, uint32_t screenWidth, uint32_t screenHeight)//221c50
{
	ViewPort viewPort;
	...
	viewPort.PosX_EA3D0 = widthKoef * factor;
	viewPort.PosY_EA3CC = heightKoef * factor;
	viewPort.Width_DE564 = widthKoef * 2 * viewPortSizeSetting;
	viewPort.Height_DE568 = heightKoef * 2 * viewPortSizeSetting;
