...
Bit8u* sub_15CB0(Bit8u* a1, Bit8u* a2); // weak
char sub_15D40(__int16 a1, Bit8u* a2, Bit8u* a3); // weak
...
void sub_47560_events_in_game(Bit8u* a1, int a2, Bit32u a3, signed int a4, __int16 a5);
void sub_51BB0_game_events(Bit8u* a1);
//x_DWORD /*__cdecl*/ toupper(x_DWORD); //weak
void sub_55C60(Bit8u* a1, int a2, Bit8u* a3);
