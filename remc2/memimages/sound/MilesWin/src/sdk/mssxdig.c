...
static void XDIG_set_volume(HWAVESYNTH W, S32 voice)
{
   ...
   AIL_set_sample_volume_pan(W->S[voice],v/127.0f,W->controls.pan[c]/127.0f);
}
                          ...
                          S32        patch)
{
   ...
   W = (HWAVESYNTH) (UINTa) mdi->system_data[0];
                                                  ...
                                                  S32        polyphony)
{
   ...
   mdi->system_data[0] = (SINTa) (UINTa) W;
   ...
   for (i=0; i < NUM_CHANS; i++)
      ...
      W->controls.bend_range[i] = (S32) AIL_preference[MDI_DEFAULT_BEND_RANGE];
      }
