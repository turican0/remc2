...
//##  Miles Sound System                                                    ##
//##                                                                        ##
//##  API.CPP: FLT module for Low Pass Filter                               ##
//##                                                                        ##
...
#define FILTER_NAME "LowPass Filter"

// Cutoff Default
#define  _FX_CUTOFF_DEFAULT   100.0F
...
static void  FXCalcParams( SAMPLESTATE FAR * SS, S32 sample_rate )
{
   ...
   F32 fC = 1.0F / (F32) AIL_tan( F_PI * SS->fCutoffFreq / fRate );

   // calculate coefficients
   SS->fA[ 0 ] =  1.0F / ( 1.0F + AIL_fsqrt( 2.0F ) * fC + fC * fC );
   SS->fA[ 1 ] =  (F32)2.0F * SS->fA[ 0 ];
   SS->fA[ 2 ] =  SS->fA[ 0 ];
...
extern "C" S32 LowPassMain( HPROVIDER provider_handle, U32 up_down );
extern "C" S32 LowPassMain( HPROVIDER provider_handle, U32 up_down )
{
