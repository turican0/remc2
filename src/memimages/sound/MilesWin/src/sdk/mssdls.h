...
typedef S32    (AILCALLBACK FAR * AILDLSPCB) (UINTa user);
...
typedef void FAR * (AILCALLBACK FAR * AILDLSLCB) (UINTa user, S32 buffer_section);
...
typedef void   (AILCALLBACK FAR * AILDLSUCB) (UINTa user, S32 buffer_section);
...
DXDEC S32 AILCALL DLSMSSOpen      (SINTa FAR   *lpdwHandle,
                                   S32        dwFlags,
...
DXDEC S32 AILCALL DLSOpen          (SINTa FAR *lpdwHandle,
                                    S32      dwFlags);

DXDEC S32 AILCALL DLSClose         (SINTa    dwDLSHandle,
                                    S32      dwFlags);

DXDEC S32 AILCALL DLSLoadFile      (SINTa    dwDLSHandle,
                                    S32      dwFlags,
...
DXDEC S32 AILCALL DLSFSSLoadFile   (SINTa    dwDLSHandle,
                                    S32      dwFlags,
                                    SINTa FAR *lpdwDownloadID,
...
DXDEC S32 AILCALL DLSLoadMemFile   (SINTa    dwDLSHandle,
                                    S32      dwFlags,
                                    SINTa FAR *lpdwDownloadID,
...
DXDEC S32 AILCALL DLSCompactMemory (SINTa    dwDLSHandle);

DXDEC S32 AILCALL DLSUnloadAll     (SINTa    dwDLSHandle,
                                    S32      dwFlags);

DXDEC S32 AILCALL DLSMSSGetCPU     (SINTa    dwDLSHandle);

DXDEC S32 AILCALL DLSUnloadFile    (SINTa    dwDLSHandle,
                                    SINTa    dwDownloadID);

DXDEC S32 AILCALL DLSSetAttribute  (SINTa    dwDLSHandle,
                                    S32      dwAttribute,
                                    void FAR*lpDlsParam);

typedef S32 (AILCALL FAR *DLSMSSOPEN)(SINTa FAR *lpdwHandle,
                                      S32        dwFlags,
                                      HMDIDRIVER MIDI_driver,        // XMIDI driver handle
                                      S32        output_format,      // DIG_F format for output
                                      S32        output_sample_rate, // Output samples/second
...
typedef S32 (AILCALL FAR *DLSOPEN)          (SINTa FAR *lpdwHandle,
                                             S32        dwFlags);

typedef S32 (AILCALL FAR *DLSCLOSE)         (SINTa    dwDLSHandle,
                                             S32      dwFlags);

typedef S32 (AILCALL FAR *DLSLOADFILE)      (SINTa    dwDLSHandle,
                                             S32      dwFlags,
                                             SINTa FAR *lpdwDownloadID,
                                             char const FAR*lpFileName);
...
typedef S32 (AILCALL FAR *DLSFSSLOADFILE)   (SINTa    dwDLSHandle,
                                             S32      dwFlags,
                                             SINTa FAR *lpdwDownloadID,
                                             FSSpec const FAR*lpFileName);
...
typedef S32 (AILCALL FAR *DLSLOADMEMFILE)     (SINTa    dwDLSHandle,
                                               S32      dwFlags,
                                               SINTa FAR *lpdwDownloadID,
                                               void const FAR*lpMemPtr);
...
typedef S32 (AILCALL FAR *DLSCOMPACTMEMORY)     (SINTa    dwDLSHandle);

typedef S32 (AILCALL FAR *DLSUNLOADALL)         (SINTa    dwDLSHandle,
                                                 S32      dwFlags);

typedef S32 (AILCALL FAR *DLSUNLOADFILE)        (SINTa    dwDLSHandle,
                                                 SINTa    dwDownloadID);

typedef S32 (AILCALL FAR *DLSSETATTRIBUTE)      (SINTa     dwDLSHandle,
                                                 S32       dwAttribute,
                                                 void FAR* lpDlsParam);
