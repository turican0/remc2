...
uint8_t* sub_9DEA0_read_file(const std::filesystem::path& a1, uint8_t* a2)//27eea0
{
	...
	x_DWORD_E3E2C = 0;
	v5 = std::filesystem::file_size(a1);
	if (v5 == -1)
	{
		x_DWORD_E3E2C = 3;
		result = 0;
...
//----- (0009DE20) --------------------------------------------------------
ssize_t sub_9DE20_get_file_length(const std::filesystem::path& a1)//27ee20
{
	return std::filesystem::file_size(a1);
}
