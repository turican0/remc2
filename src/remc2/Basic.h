...
typedef struct {
	...
	size_t var36_size_buffer;//24 //maybe file size
...
ssize_t sub_9DE20_get_file_length(const std::filesystem::path& a1);
uint8_t* sub_9DEA0_read_file(const std::filesystem::path& a1, uint8_t* a2);
