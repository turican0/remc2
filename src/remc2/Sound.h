...
HDIGDRIVER sub_93330_AIL_install_DIG_driver_file(const char* filename, IO_PARMS* IO);
char sub_9AE90(int eax0, int edx0, char* ebx0, int* a1, int8_t* a2, int a3, int a4);
int sub_931F0_AIL_install_DIG_INI(HDIGDRIVER* a2, const std::filesystem::path& digPath);
HMDIDRIVER sub_95850_AIL_install_MDI_driver_file(const char* filename, IO_PARMS* IO);
int32_t sub_95710_AIL_install_MDI_INI(HMDIDRIVER* mdi, const std::filesystem::path& fileName);

void sub_920D0_AIL_delay(int a1);
int sub_92160();
int LoadAILFromFile(AIL_INI* INI, const std::filesystem::path& filename);
...
int sub_9E3A0_AIL_API_read_INI(AIL_INI* INI, const std::filesystem::path& filename);
...
int sub_A3720_AIL_API_install_DIG_INI(HDIGDRIVER* dig, const std::filesystem::path& digPath);
HDIGDRIVER sub_A3600_AIL_API_install_DIG_driver_file(const char* filename, IO_PARMS* IO);
int32_t sub_A78F0_AIL_API_install_MDI_INI(HMDIDRIVER* mdi, const std::filesystem::path& fileName);
HMDIDRIVER sub_A77D0_AIL_API_install_MDI_INI(const char* filename, IO_PARMS* IO);
